...
<body>
            ...
            <form action="register_process.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn btn-outline-secondary" type="button" data-target="confirm_password">
                            <i class="ri-eye-line" id="toggleIcon-confirm_password"></i>
                        </button>
                    </div>
                </div>
                <div class="d-grid">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Select all toggle buttons using the input-group structure
            const toggleButtons = document.querySelectorAll('.input-group button[type="button"]');
            ...
            toggleButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    // Get the icon element inside this specific button
                    ...
                    if (passwordInput && toggleIcon) {
                        ...
                        if (newType === 'text') {
                            // Show password: switch icon to 'eye-off'
                            toggleIcon.classList.remove('ri-eye-line');
                            toggleIcon.classList.add('ri-eye-off-line');
                        } else {
                            // Hide password: switch icon to 'eye'
